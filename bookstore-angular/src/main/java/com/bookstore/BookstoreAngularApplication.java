...
public class BookstoreAngularApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		user1.setLastName("Ozturkan");
		user1.setUsername("dok");
		user1.setPassword(SecurityUtility.passwordEncoder().encode("dokpass"));
		user1.setEmail("d.ozturkan@gmail.com");
		...
		user2.setEmail("dogukanozturkan@gmail.com");
		Role role2 = new Role();
		role2.setRoleId(0);
